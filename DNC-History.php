...
checkUser($main_conn);
$TITLE_PAGE="All Time DNC Wallet History";
$uid=getSession("USER_ID",$main_conn,"0");

$html_deposits=report_panel(31,$main_conn);
checkSecurity($uid,$main_conn,'transferdnc');
checkSecurity($uid,$main_conn,'transactiondnc');
...
js;
?>
<h2 class="page-title">All Time DNC History </h2>
