...
<html lang="en-us" id="extr-page">
	<head>
		<meta charset="utf-8">
		<title> <?php echo($TITLE)?>:: Retrive Password Form</title>
	...
	<body class="animated fadeInDown">
		...
		<header id="header">
			...
			<span id="extr-page-header-space"> <span class="hidden-mobile">Need an account?</span> <a href="register.php" class="btn btn-danger">Creat account</a> </span>
						...
						<div class="well no-padding">
							<form action="login.html" id="login-form" class="smart-form client-form">
								...
								<fieldset>
									...
									<section>
										<label class="label">Your Account number</label>
										<label class="input"> <i class="icon-append fa fa-user"></i>
											<input type="text" name="username">
											<b class="tooltip tooltip-top-right"><i class="fa fa-user txt-color-teal"></i> Enter your Account number</b> </label>
										<div class="note">
